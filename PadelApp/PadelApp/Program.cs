...
IGameAPI gameAPI = RestService.For<IGameAPI>(new HttpClient() { BaseAddress = new Uri("http://padelpoints.azurewebsites.net/games") }); //"https://padelpoints.azurewebsites.net/games"
